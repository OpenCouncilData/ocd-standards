...
Field | Description
------|------------
`status`| The default dog-walking status for this area, one of: <br><ul><li> `offleash` (also known as "free roam areas")</li><li>`onleash`</li><li>`no` (also known as "dog ban areas")</li></ul>
